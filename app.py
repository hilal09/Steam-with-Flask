"""
Author: Zeinab Barakat(dashboard, dashboard_data, get_all_series, add_series, delete_series), Hilal Cubukcu(login, register, logout, add_series), Melisa Rosic Emira(profile, update_profile, delete_account), Yudum Yilmaz
